...
describe('knowledge base page', () => {
  it('sert la page de base de connaissance', async () => {
    ...
    expect(res.text).toContain('id="diagram-fullscreen-detail-panel"');
    expect(res.text).toContain('id="diagram-fullscreen-detail-title"');
    ...
    expect(res.text).toContain('id="diagram-equipment-upload-btn"');
    expect(res.text).toContain('id="diagram-equipment-config-input"');
