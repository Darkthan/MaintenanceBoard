...
function ensureResponsiveStyles() {
  ...
  style.textContent = `
    ...
    /* ── Styles phone-only : petit écran (< 768px) ──────────────────────────── */
...
function ensureSpotlightMarkup() {
  ...
  overlay.addEventListener('click', event => {
    ...
    const closeTarget = event.target.closest('[data-spotlight-close="true"]');
  ...
  overlay.querySelectorAll('[data-spotlight-close="true"]').forEach(element => {
...
function renderNav(activePage) {
  ...
  const navItems = [
    ...
    { href: '/ip-addressing.html', label: 'Plan d\'adressage', icon: 'M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9', id: 'ip-addressing' },
