...
function renderNav(activePage) {
  ...
  const navItems = [
    ...
    { href: '/tickets.html', label: 'Tickets', icon: 'M8 7V5a2 2 0 012-2h4a2 2 0 012 2v2m-8 0h8m-8 0H5a2 2 0 00-2 2v3a2 2 0 010 4v3a2 2 0 002 2h3m8-12h3a2 2 0 012 2v3a2 2 0 000 4v3a2 2 0 01-2 2h-3M8 7v14m8-14v14', id: 'tickets' },
